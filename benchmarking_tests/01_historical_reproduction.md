...
This validates the exact anchor, not yet a historical-data reproduction: the
archived paper table/trace has not been matched to this point. It also confirms
that adaptive extension should be observable-specific rather than treating
energy convergence as certification of FS.
...
independent seed groups under the preregistered tolerance. Advanced ES and FS
need more samples than energy and heat capacity to meet their production
precision target.

## Open Questions

- Which archived file is the authoritative prior result for this exact anchor?
