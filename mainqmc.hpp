...
double compute_derived_observable(int n) { // we compute the derived observables
  ...
  case 0:
    R = mean_O[Nobservables + 8] -
        run_beta * mean_O[Nobservables + 2] * mean_O[Nobservables + 2];
    break;
  case 1:
    R = mean_O[Nobservables + 9] - (run_beta * mean_O[Nobservables + 2]) *
                                       (run_beta * mean_O[Nobservables + 2]) / 8;
    break;
  case 2:
    R = mean_O[Nobservables + 11] -
        run_beta * mean_O[Nobservables + 4] * mean_O[Nobservables + 4];
    break;
  case 3:
    R = mean_O[Nobservables + 12] - (run_beta * mean_O[Nobservables + 4]) *
                                        (run_beta * mean_O[Nobservables + 4]) / 8;
    break;
  case 4:
    R = run_beta * run_beta *
